...
type EventRegistration = RegistrationData;

const EventRegisterUser: React.FC = () => {
  ...
  const fetchEventRegistrations = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const eventRegistrations = data.registrations.filter((reg: any) => reg.type === 'event');
  ...
  const handleExportToExcel = () => {
    exportToExcel(registrations, 'event_registrations.xlsx');
  };

  const handleExportChildrenToExcel = () => {
    exportChildrenToExcel(registrations, 'event_children.xlsx');
  };

  const sendEmail = (registration: EventRegistration) => {
          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <button
                ...
                className="mr-4 p-2 text-gray-400 hover:text-emerald-600 transition-colors"
              >
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="flex items-center px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-teal-600 to-green-600 rounded-lg hover:from-teal-700 hover:to-green-700 transition-all duration-200"
              >
                <Download className="w-4 h-4 mr-2" />
                Export Children
              </button>
